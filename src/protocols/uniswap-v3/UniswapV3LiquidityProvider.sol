...
contract UniswapV3LiquidityProvider {
    ...
    function calculateLiquidityFromUSDC(
        ...
        if (sqrtPriceX96 <= sqrtPriceLowerX96) {
            ...
            liquidity = getLiquidityForAmount0(sqrtPriceLowerX96, sqrtPriceUpperX96, usdcAmount);
        } else if (sqrtPriceX96 >= sqrtPriceUpperX96) {
            // All WETH, no USDC - return 0 since we only have USDC
            liquidity = 0;
        } else {
            // Current price is in range, calculate proportional liquidity
            liquidity = getLiquidityForAmount0(sqrtPriceX96, sqrtPriceUpperX96, usdcAmount);
        }
    }
    ...
    function getLiquidityForAmount0(
        ...
        uint256 intermediate = (uint256(sqrtRatioAX96) * uint256(sqrtRatioBX96)) >> 96;
    ...
    function addLiquidityWithUSDCAmount(
        ...
        uint128 liquidity = calculateLiquidityFromUSDC(pool, usdcAmount, tickLower, tickUpper);

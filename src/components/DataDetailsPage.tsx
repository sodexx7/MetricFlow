...
import { ArrowLeft, TrendingUp, TrendingDown, Activity, DollarSign, Fuel, Users } from 'lucide-react';
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Comprehensive blockchain metrics and insights</p>
            </div>
          </div>
                ...
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <AreaChart data={priceData}>
                      ...
                      />
                      <Area type="monotone" dataKey="volume" stroke="#10b981" fill="#10b981" fillOpacity={0.2} />
                    </AreaChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center justify-between p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="bg-green-500/20 text-green-500 border-green-500/30">Low</Badge>
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="bg-yellow-500/20 text-yellow-500 border-yellow-500/30">Medium</Badge>
                ...
                <div className="flex items-center justify-between p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="bg-red-500/20 text-red-500 border-red-500/30">High</Badge>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Average Pool Size</p>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={350}>
                  <AreaChart data={transactionData}>
                    ...
                    />
                    <Legend />
                    <Area type="monotone" dataKey="txCount" stackId="1" stroke="#3b82f6" fill="#3b82f6" fillOpacity={0.3} name="Total Transactions" />
                    <Area type="monotone" dataKey="success" stackId="2" stroke="#10b981" fill="#10b981" fillOpacity={0.3} name="Successful" />
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-4 gap-6">
                  ...
                  <div>
                    <p className="text-sm text-muted-foreground">Avg. Tx Value</p>
